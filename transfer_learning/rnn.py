...
def net(x):
    ...
    with tf.variable_scope("RNN"):
        input_RNN = tf.reshape(fc1, (-1, time_step, 128))
        RNN_cell = tf.nn.rnn_cell.BasicRNNCell(num_units=50)
        initial_state_RNN = RNN_cell.zero_state(batch_size, tf.float32)
...
if (__name__ == "__main__"):
    ...
    path_source = "dataset/20171017_51-53.csv"
    path_target = "dataset/20170928_51-53.csv"
